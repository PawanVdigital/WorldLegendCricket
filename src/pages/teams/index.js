...
export async function getServerSideProps({ req }) {
  return {
    props: {
      ...
      meta_title:
        "World Championship of Legends Cricket Teams List 2025: Full Squads Revealed - WCL T20",
      meta_description:
        "Explore the complete World Championship of Legends Cricket teams list for 2025! Check out the full squads, including star players like Yuvraj Singh, Shahid Afridi, and more, competing in this epic T20 tournament starting July 18, 2025, at Edgbaston Stadium.",
      meta_keywords:
        "World Championship of Legends Cricket teams list 2025, T20 tournament, Edgbaston, Northampton, WCL T20",
      page_content: `
